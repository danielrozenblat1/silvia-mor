...
const NavBarNew = () => {
  ...
  const handleClick = () => {
    ...
    const message = "היי סילביה ,אני רוצה לשמוע ממך עוד על..";
  ...
  return (
    <nav className={`${styles.navbar} ${isSticky ? styles.sticky : ''}`}>
        ...
        <div className={`${styles.mobileMenu} ${isClosing ? styles.closing : ''}`}>
          <div className={styles.mobileMenuContent}>
            ...
            <div className={styles.center}>
              <img className={styles.image} src={logo} alt="סילביה מור לוגו"/>
            </div>
          </div>
        </div>
      )}
      ...
      <div className={styles.socialIcons}>
        <a href="https://www.instagram.com/silvia.mor.academy/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
